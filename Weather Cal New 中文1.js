...
const apiKey = "3f2390fe56dc7274b8402dce2fc57ef2"
...
const localizedText = {
  ...
  nightGreeting: "该睡觉了🥱 主人"
  ,morningGreeting: "早上好呀😜 主人"
  ,noonGreeting: "中午好 🤪 主人"
  ,afternoonGreeting: "下午好 ☺️ 主人"
  ,eveningGreeting: "晚上好 ☺️ 主人"
...
const textFormat = {
  ...
  largeDate1:  { size: 16, color: "", font: "light" },
  ...
  noEvents:    { size: 15, color: "", font: "semibold" },
  ...
  Poetry:      { size: 12, color: "", font: "medium" },
...
//   var hltemptext = widgetHello.addText(feel);
  ...
  let poetry = provideText(feel, greetingStack, textFormat.Poetry)
  greetingStack.setPadding(0, padding, padding, 0)
}
...
async function date(column) {
  ...
  // Otherwise, show the large date.
    ...
    dateTwoStack.setPadding(5, padding, padding, padding) // top right bottom left
  }
}
...
async function greeting(column) {
  ...
  greetingStack.setPadding(15, padding, padding, padding)
}
...
async function current(column) {
  ...
  currentWeatherStack.setPadding(10, 0, 0, 0)
...
async function sunrise(column) {
  ...
  sunriseStack.setPadding(padding, padding, padding * 1, padding)
